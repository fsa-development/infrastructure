...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => $UserDir,
			'upload_url' => 'https:'.$StaticPath.'/uploads/',
...
class SuiteUploadHandler extends UploadHandler {
    ...
    protected function trim_file_name($file_path, $name, $size, $type, $error, $index, $content_range) {
		...
		switch(exif_imagetype($file_path)) {
			...
			default:
				exit('{ "error": "This is no photo"}');
				break;
		}

		$name = str_replace('.', '',		('img_' . microtime(true))		);
		$name =  $name . '.' . $ext;
        return $name;
    }
}
 ...
 *
 */
$UserDir = $RuntimePath.'/static/uploads/';
$oldmask = umask(0);
global $StaticPath;
global $ServicePathAlias;

$upload_handler =
    new SuiteUploadHandler([ 'upload_dir'    =>  $UserDir,
                        'upload_url'    => 'https:'.$StaticPath.'/uploads/',
                        'script_url'    => $ServicePathAlias.'/UploadHandler.php'
    ]);
